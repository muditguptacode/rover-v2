...
1. To check that *DiffBot* description is working properly use following launch commands
   ...
   .. code-block:: shell
    ...
    ros2 launch diffdrive_roboclaw view_robot.launch.py
...
2. To start *DiffBot* example open a terminal, source your ROS2-workspace and execute its launch file with
   ...
   .. code-block:: shell
    ...
    ros2 launch diffdrive_roboclaw diffbot.launch.py
...
5. If everything is fine, now you can send a command to *Diff Drive Controller* using ROS 2 CLI interface:
   ...
   .. code-block:: shell
    ...
    [DiffDriveRoboclawHardware]: Got command 43.33333 for 'left_wheel_joint'!
    [DiffDriveRoboclawHardware]: Got command 50.00000 for 'right_wheel_joint'!
...
6. Let's introspect the ros2_control hardware component. Calling
  ...
  .. code-block:: shell
    ...
    Hardware Component 1
            name: DiffBot
            type: system
            plugin name: diffdrive_roboclaw/DiffDriveRoboclawHardware
  ...
  .. code-block:: shell
    ...
    ros2 launch diffdrive_roboclaw diffbot.launch.py use_mock_hardware:=True
